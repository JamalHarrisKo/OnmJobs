 ...
 * @returns {@link @formkit/core#FormKitTypeDefinition | FormKitTypeDefinition}
 ...
 submit: (_data: any, _node?: FormKitNode | undefined) => boolean;
 submitRaw: (_event: Event, _node?: FormKitNode | undefined) => boolean;
 submitInvalid: (_node?: FormKitNode | undefined) => boolean;
 ...
 }, () => RenderableList | RenderableSlots, unknown, {}, {}, ComponentOptionsMixin, ComponentOptionsMixin, {}, string, VNodeProps & AllowedComponentProps & ComponentCustomProps, Readonly<ExtractPropTypes<    {
 schema: {
 type: PropType<FormKitSchemaCondition | FormKitSchemaNode[]>;
 required: true;
 };
  ...
  * @public
  */
 export declare type RenderableSlot = (data?: Record<string, any>, key?: symbol) => RenderableList;
